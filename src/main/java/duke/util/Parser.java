    ...
    public static Command parse(String input) {
        ...
        case "todo":
            try {
                ...
                return new FaultyCommand(new DukeException("The description of a todo cannot be empty."));
            }
        case "deadline":
            try {
                ...
                return new FaultyCommand(new DukeException("The description of a deadline cannot be empty."));
            }
        case "event":
            try {
                ...
                return new FaultyCommand(new DukeException("The description of an event cannot be empty."));
            }
        case "delete":
            try {
                ...
                return new FaultyCommand(new DukeException("Please specify which task to delete."));
            }
        case "find":
            try {
                return new FindCommand(command[1]);
            } catch (ArrayIndexOutOfBoundsException e) {
                return new FaultyCommand(new DukeException("The description of a find query cannot be empty."));
            }
        case "recur":
            try {
                ...
                return new FaultyCommand(new DukeException("The description of a recur command cannot be empty."));
            }
        default:
