# JavaFX Tutorial Part 2 - Creating a GUI for duke.user.DukeUI

In this tutorial, we will be creating a GUI for duke.user.DukeUI from scratch based on the following mockup.

![Mockup for duke.user.DukeUI](assets/DukeMockup.png)
...
![duke.user.DukeUI's layout](assets/DukeSceneGraph.png) 
...
![duke.user.DukeUI's raw layout](assets/RawLayout.png)
...
```java
    ...
    public void start(Stage stage) {
        ...
        stage.setTitle("duke.user.DukeUI");
...
![duke.user.DukeUI's Final layout](assets/FinalLayout.png)
